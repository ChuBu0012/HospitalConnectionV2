...
const Register = () => {
    ...
    const handleSubmit = () => {
        ...
        Swal.fire({
            ...
            if (res.isConfirmed) {
                setloading(true);
                createAccounts({ ...state, image: Image }).then((res) => {
                    Swal.fire({
                        icon: 'success',
                        title: 'บันทึกสำเร็จ',
                        text: 'Good job!',
    ...
    return (
        <Navbar>
            ...
            </div> : <div className=' h-srceen  min-h-[1400px] lg:min-h-screen pb-10 container max-w-4xl m-auto'>
                <h1 className='text-center text-2xl font-bold mb-10'>ลงทะเบียนบุคลากรทางการแพทย์</h1>
                <form onSubmit={(e) => {
                    e.preventDefault()
                    handleSubmit()
                    ...
                    <div className='flexitemcenter justify-between'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="idcard" type="text" name='idcard' placeholder='idcard' onInput={(e) => setvalue(e, 'idcard')} className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                    ...
                    <div className='flexitemcenter justify-between mt-4'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="doctor_id" name='doctor_id' placeholder='doctor_id' onInput={(e) => setvalue(e, 'doctor_id')} type="text" className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>
                    <div className='flexitemcenter justify-between mt-4'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="password" name='password' placeholder='กรุณาป้อนรหัสผ่าน' onInput={(e) => setvalue(e, 'password')}
                                type="password" className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>
                    <div className='flexitemcenter justify-between mt-4'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="conpassword" name='conpassword' placeholder='กรุณาป้อนรหัสผ่านอีกครั้ง' onInput={(e) => setConpassword(e.target.value)}
                                type="password" className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>
                    <div className='flexitemcenter justify-between mt-4'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="name" type="text" name='name' placeholder='name' onInput={(e) => setvalue(e, 'name')} className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>

                    <Brithday setDay={(e) => setBirthdayDay(e, 'day')} setMonth={(e) => setBirthdayDay(e, 'month')} setYear={(e) => setBirthdayDay(e, 'year')} />

                    <div className='flexitemcenter justify-center mt-2'>
                        <label>อายุ</label>
                        <div className='whitespace-nowrap '>
                            <input id="age" type="text" value={state.age} disabled name='age' placeholder='กรุณาเลือกวันเกิด' className='outline-none ml-4 w-12 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>
                    ...
                    <div className='flexitemcenter justify-between mt-4'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="organization" type="text" name='organization' placeholder='organization' onInput={(e) => setvalue(e, 'organization')} className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>
                    ...
                    <div className='flexitemcenter justify-between mt-4'>
                        <label>ตำแหน่ง</label>
                        <div className='whitespace-nowrap'>
                            <input id="position" type="text" name='position' placeholder='position' onInput={(e) => setvalue(e, 'position')} className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>
                    ...
                    <div className='flexitemcenter justify-between mt-4'>
                        ...
                        <div className='whitespace-nowrap'>
                            <input id="phone" type="text" name='phone' placeholder='phone' onInput={(e) => setvalue(e, 'phone')} className=' outline-none ml-4 rounded bg-bginput px-2 py-1 border' />
                            <label className='text-2xl text-red-500 ml-2'>*</label>
                        </div>
                    </div>

                    {
                        Image ? "" : <div className="flex items-center justify-center w-full mt-8">
                                ...
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg className="w-8 h-8 mb-4 text-gray-500 "
                                        ...
                                        <path stroke="currentColor"
                                            strokeLinecap="round"
                                            strokeLinejoin="round" strokeWidth="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                                    </svg>
                                    <p className="mb-2 text-sm text-gray-500 text-center "><span className="font-semibold">Click to upload Profile</span></p>
                                </div>
                                <input id="dropzone-file" type="file" className="hidden" onChange={(e) => covertToBase64(e)} />
                            </label>
                        </div>
                    }

                    {
                        ...
                        <div className='relative mt-8'>
                            <img src={Image} className='  m-auto rounded-lg object-contain max-h-[256px]' height={256} width={500} alt="" />
                            <label for="dropzone-file" className="opacity-0 absolute top-0 flex flex-col items-center justify-center 
                        w-3/4 md:w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100 ">
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg className="w-8 h-8 mb-4 text-gray-500 "
                                        xmlns="http://www.w3.org/2000/svg"
